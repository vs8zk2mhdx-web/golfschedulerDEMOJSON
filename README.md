NO LONGER IN USE. Uses JSON. CAN BE USED AS DEMO. This is current Golf Scheduler with pairs kept together and modification of roster and car pool managment, and downloading the tee sheet to the clipboard. It corresponds to the index.html file in 2026 initialization folder, GolfSchedulerPair.html . This version keeps pairs of people together. The scheduler without Pairs in the title won't. This version allowed tee time to be changed, for frost delay, on a weekly basis if needed. it has a 20 week season schedule. It fixed a bug associated with displaying all future weeks. 
May 3, 2026 6:07 pm 
